...
\clearpage
\section*{Bibliografické údaje}

\textbf{Autor:} Tomáš Panovský\\
\textbf{Název práce:} Diskrétní simulace v SimPy\\
\textbf{Typ práce:} bakalářská práce\\
\textbf{Pracoviště:} Katedra informatiky, Přírodovědecká fakulta, Univerzita Palackého v Olomouci\\
\textbf{Rok obhajoby:} 2026\\
\textbf{Studijní program:} Informační technologie, prezenční forma\\
\textbf{Vedoucí práce:} Mgr. Jan Laštovička, Ph.D.\\
\textbf{Počet stran:} Vo hvězdách\\
\textbf{Přílohy:} elektronická data v úložišti katedry informatiky\\
\textbf{Jazyk práce:} český

\vspace{1cm}

\section*{Bibliographic info}

\textbf{Author:} Tomáš Panovský\\
\textbf{Title:} Discrete-event simulation in the SimPy library\\
\textbf{Thesis type:} bachelor thesis\\
\textbf{Department:} Department of Computer Science, Faculty of Science, Palacký University Olomouc\\
\textbf{Year of defense:} 2026\\
\textbf{Study program:} Information Technologies, full-time form\\
\textbf{Supervisor:} Mgr. Jan Laštovička, Ph.D.\\
\textbf{Page count:} XX\\
\textbf{Supplements:} electronic data in the storage of the Department of Computer Science\\
\textbf{Thesis language:} Czech
...
\textbf{Klíčová slova:} simulace, SimPy, vizualizace, organizace, fronty, festival\\
\textbf{Keywords:} simulation, SimPy, visualization, organization, queues, festival

\clearpage

{\Large
Děkuji vedoucímu práce Mgr. Janu Laštovičkovi, Ph.D. za ochotu, velmi cenné rady,\\
trpělivost a vedení mé bakalářské práce.
}

\vspace{2cm}

Odevzdáním tohoto textu jeho autor/ka místopřísežně prohlašuje, že celou práci
včetně příloh vypracoval/a samostatně a za použití pouze zdrojů citovaných v textu
práce a uvedených v seznamu literatury.
